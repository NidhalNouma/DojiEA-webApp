        ...
        <div className="pt-12 md:pt-20">
          ...
          >
            ...
            <p className="text-xl text-slate-500">
              ...
              market, other traders have proven Irins Expert Advisor
              performance.
            </p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                ...
                <a
                  className={`flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${
                    tab !== 2
                      ? "bg-slate-500 shadow-md border-slate-400 hover:shadow-lg"
            ...
            {/* Tabs items */}
            <div
              className="flex-col justify-content items-center max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1"
              ref={tabs}
            >
              <iframe
